...
train_path = "C:/Users/jnmor/Desktop/ForSteos/ForDavidsito/train/"
test_path = "C:/Users/jnmor/Desktop/ForSteos/ForDavidsito/test/"
folders_train = os.listdir(train_path) 
folders_train.remove('desktop.ini')
folders_test = os.listdir(test_path)
folders_test.remove('desktop.ini')
print(folders_train)
print(folders_test)
...
for i in range(len(folders_train)):
    ...
    inter1 = os.listdir(path_emotion)
    inter1.remove('desktop.ini')
    filenames=sorted(inter1)      
    #print("..................")
    #print(filenames)
...
lable_list_test=[] # save the test emotion label  [0 'angry', 1'disgust', 2'fear', 3'happy', 4'neutral', 5'sad', 6'surprise']

for i in range(len(folders_test)):
    path_emotion=test_path+folders_test[i]
    inter2 = os.listdir(path_emotion)
    inter2.remove('desktop.ini')
    filenames=sorted(inter2)    
    #print("..................")
    #print(filenames)
    for j in range(len(filenames)):
...
joblib.dump(neigh, 'TrainedModel.sav', compress=0,protocol=2) # save the model
